...
const Asidebar = () => {
  return (
    <nav className="sidebar" style={{ background: "transparent", backdropFilter: "blur(10px)", border: "none", boxShadow: "none" }}>

      <ul className="list-unstyled">
        <strong style={{display:"flex",justifyContent:"center",fontSize:"30px"}}>Tune Trail</strong>
        <strong style={{display:"flex",justifyContent:"center",fontSize:"13px"}}>Your Pathway To Perfect Playlist</strong>
        <h5 style={{color:"white",paddingTop:"0px"}} className='text-center'>(Admin)</h5>
